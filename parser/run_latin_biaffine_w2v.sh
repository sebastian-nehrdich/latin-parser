...
model_path="latin-proiel-w2v"


echo "#################################################################"
echo "Currently BiAFFINE model training in progress..."
echo "#################################################################"
python parser/GraphParser.py --domain $domain --rnn_mode LSTM --use_w2v --use_char --use_case --use_gender --use_number --use_verb_form --use_full_pos --use_pos_type --num_epochs $num_epochs --batch_size 32 --hidden_size 512 --arc_space 512 \
