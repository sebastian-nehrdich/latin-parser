...
model_path="latin-test"


echo "#################################################################"
echo "Currently BiAFFINE model training in progress..."
echo "#################################################################"
# for full tag training: --use_pos_type --use_case --use_number --use_gender --use_verb_form --use_full_pos --use_char --use_punc --use_class
#  --use_pos_type --use_case --use_number --use_gender --use_verb_form --use_full_pos --use_char --num_epochs $num_epochs --batch_size 32 --hidden_size 512 --arc_space 512 \
# TODO: Big problem - number is not working!! Debug me... 
python parser/GraphParser.py --domain $domain --rnn_mode LSTM --use_w2v --use_char --use_case --use_gender --use_verb_form --use_full_pos --use_pos_type --num_epochs $num_epochs --batch_size 32 --hidden_size 512 --arc_space 512 \
